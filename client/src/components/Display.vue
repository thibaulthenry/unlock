<template>
  <v-card
      ...
      class="display-info"
  >
    <v-card-title class="d-flex justify-center font-italic">
    ...
    >
      <span v-if="game && game.sceneKey && lobby.state === lobbyStates.STARTED"> {{ $t('display.tips.game.' + game.sceneKey) }}</span>
